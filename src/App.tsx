        ...
        <body>
          ...
          <main>
            <section id="Distance search list">
              ...
              <form id="latitude">
                <label htmlFor="search-query">Introduzca su posicion y distancia deseada:</label>
                <input type="text" id="search-query" name="search-query" placeholder="Latitud..." required></input>
                <input type="text" id="search-query" name="search-query" placeholder="Longitud..." required></input>
                <input type="text" id="search-query" name="search-query" placeholder="Distancia..." required></input>
